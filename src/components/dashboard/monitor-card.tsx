        ...
        <div className="flex items-start gap-3">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              <DropdownMenuItem onClick={(e) => { e.preventDefault(); onCheck?.(); }}>
              ...
              {isActive ? (
                <DropdownMenuItem onClick={(e) => { e.preventDefault(); onPause?.(); }}>
                  <svg className="w-4 h-4 mr-2" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                ...
                <DropdownMenuItem onClick={(e) => { e.preventDefault(); onResume?.(); }}>
                  <svg className="w-4 h-4 mr-2" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
