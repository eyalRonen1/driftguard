    ...
    <div className="min-h-screen flex items-center justify-center bg-jungle-stage">
      <div className="w-full max-w-md p-8 card-glass">
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-[var(--text-cream)] mb-1">Full name</label>
            <input
              type="text"
              value={name}
          ...
          <div>
            <label className="block text-sm font-medium text-[var(--text-cream)] mb-1">Password</label>
            <input
              type="password"
              value={password}
